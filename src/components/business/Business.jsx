...
import { AboutMeButton } from '../.././components/index/components.index'

const FeatureCard = ({ icon, title, content, index }) => {
    return (
      <div className={`flex flex-row p-6 rounded-[20px] ${index !== features.length -1 ? "mb-8" : "mb-0"} feature-card`}>
...
const Business = () => {
  return (
    ...
    <div className={layout.sectionInfo}>
      ...
      Being able to understand the big picture means being able to
