...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div
      className={`flex justify-start items-center flex-col w-[200px] sm:w-[300px] rounded-[20px] m-3 z-[1] glass-card shadow transform`} //height properties in ProjectCardIcons component
    >
